				...
				<div class="card-columns">
					...
					<div class="card">
						...
						<div class="card-footer text-center">
							...
							<button class="btn btn-outline-success"> Ugshs: <%=p.getPriceAfterApplyDiscount()%>/- <span class="text-secondary discount-label">  Ugshs: <%=p.getpPrice() %> <%=p.getpDiscount() %>%</span></button>
						</div>
					</div>
					<%
						}
